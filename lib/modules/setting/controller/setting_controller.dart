...
import 'package:gartix/shared/components/settings/api_config.dart';
import 'package:gartix/shared/components/settings/printer_manager.dart';
import './setting.dart';
    ...
    try {
      ...
      Get.showSnackbar(
        const GetSnackBar(
          ...
          message: 'Periksa koneksi perangkat',
          icon: Icon(
            CupertinoIcons.printer,
            color: Colors.white,
          ),
